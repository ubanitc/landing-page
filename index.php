  ...
  <body>
        ...
        <div class="collapse navbar-collapse navbar-right navbar-ex1-collapse">
          <ul class="nav navbar-nav">
            ...
            <li>
              ...
              >
                <span class="network-name">Register</span></a
              >
            </li>
          </ul>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 col-lg-offset-2 col-sm-6">
            <img class="img-responsive" src="img/woman.jpg" alt="" />
          </div>
        </div>
      </div>
      <!-- /.container -->
        ...
        <div class="row">
          <div class="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
            ...
            <p class="lead">
              ...
              seconds using free Photoshop actions by PSDCovers!
              <a target="_blank" href="http://www.psdcovers.com/"
                >Visit their website</a
              >
              to download some of their awesome, free photoshop actions!
            </p>
          </div>
          <div class="col-lg-5 col-sm-pull-6  col-sm-6">
            <img class="img-responsive" src="img/doge.jpg" alt="" />
          </div>
        </div>
      </div>
      <!-- /.container -->
          ...
          <div class="col-lg-5 col-sm-6">
            ...
            <p class="lead">
              ...
              <a target="_blank" href="http://www.google.com/fonts"
                >Google Web Font library</a
              >, as well as
              <a target="_blank" href="http://fontawesome.io"
                >icons from Font Awesome</a
              >.
            </p>
          </div>
          <div class="col-lg-5 col-lg-offset-2 col-sm-6">
            <img class="img-responsive" src="img/jazz.jpg" alt="" />
          </div>
        </div>
      </div>
      <!-- /.container -->
    ...
    <div class="banner">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <h2>Join the other contestants now</h2>
          </div>
          <div class="col-lg-6">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <p class="copyright text-muted small">
              Copyright &copy; Trencytech Services 2020. All Rights Reserved
            </p>
          </div>
        </div>
      </div>
